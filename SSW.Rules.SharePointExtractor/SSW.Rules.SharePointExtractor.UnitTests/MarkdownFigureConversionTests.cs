...
namespace SSW.Rules.SharePointExtractor.UnitTests
{
    public class MarkdownFigureConversionTests
    {
        ...
        public void CreateGreyBox()
        {
            ...
            converted.Should().Be("<br><br>::: greybox<br>" + content+ "  <br>:::<br>");
        }
        ...
        public void CreateChinaBox()
        {
            ...
            converted.Should().Be("<br><br>::: china<br>" + content + "  <br>:::<br>");
        }
        ...
        public void CreateInfoBox()
        {
            ...
            converted.Should().Be("<br><br>::: info<br>" + content + "  <br>:::<br>");
        }
        ...
        public void CreateWarningBox()
        {
            ...
            converted.Should().Be("<br><br>::: warning<br>" + content + "  <br>:::<br>");
        }
        ...
        public void CreateDevBox()
        {
            ...
            converted.Should().Be("<br><br>::: dev<br>" + content + "  <br>:::<br>");
        }
        ...
        public void CreateTaskBox()
        {
            ...
            converted.Should().Be("<br><br>::: task<br>" + content + "  <br>:::<br>");
        }
        ...
        public void CreateEmailTemplate()
        {
            ...
            converted.Should().Be("<br><br>::: email<br>" + content + "  <br>:::<br>");
        }
    }
}
